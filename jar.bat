...
set SERVLET_API_JAR="C:\Users\rmita\Documents\Riana\Utils\jakarta.servlet-api-5.0.0.jar"
set JAR_NAME=Test.jar
set DEPLOY_DIR="C:\Users\rmita\Documents\Riana\Uni\L3\S5\Framework\Test\webapps\WEB-INF\lib"
